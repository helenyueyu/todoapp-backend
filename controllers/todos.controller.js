...
exports.createTodo = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(400).json({status: 400, message: 'Creating todo unsuccessful.'})
  }
}
...
exports.updateTodo = async function(req, res, next) {
  ...
  try {
    ...
    return res.status(200).json({status: 200, data: updatedTodo, message: 'Successfully updated.'})
  } catch(e) {
    return res.status(400).json({status: 400, message: e.message})
  }
}
